...
{
    public class ShowmaxPaymentsService : IShowmaxPaymentsService
    {
        private readonly IHttpClientFactory _httpFactory;
        private readonly ILogger<IShowmaxPaymentsService> _logger;
        private readonly IConfiguration _configuration;
        public ShowmaxPaymentsService(
            ILogger<IShowmaxPaymentsService> logger,
        ...
        #region Shpwmax
        public async Task<BillPaymentsResponse> ShowmaxVoucehrPaymentAsync(ShowmaxVoucherRequest paymentRequest, CancellationToken cancellationToken)
        {

            _logger.LogInformation($"Inside ShowmaxVoucehrPaymentAsync service request");
