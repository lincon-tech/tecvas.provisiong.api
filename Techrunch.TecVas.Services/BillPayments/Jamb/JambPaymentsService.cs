...
{
    public class JambPaymentsService : IJambPaymentsService
    {
        private readonly IHttpClientFactory _httpFactory;
        private readonly ILogger<IJambPaymentsService> _logger;
        private readonly IConfiguration _configuration;
        public JambPaymentsService(
        ...
        #region JAMBPIN
        public async Task<BillPaymentsResponse> JambPINPaymentAsync(JambPINRequest paymentRequest, CancellationToken cancellationToken)
        {
