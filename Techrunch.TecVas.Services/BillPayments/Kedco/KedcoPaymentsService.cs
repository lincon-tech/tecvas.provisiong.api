...
{
    public class KedcoPaymentsService : IKedcoPaymentsService
    {
        private readonly IHttpClientFactory _httpFactory;
        private readonly ILogger<IKedcoPaymentsService> _logger;
        private readonly IConfiguration _configuration;
        public KedcoPaymentsService(
            ILogger<IKedcoPaymentsService> logger,
