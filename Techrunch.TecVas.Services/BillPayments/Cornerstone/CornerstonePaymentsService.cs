...
{
    public class CornerstonePaymentsService : ICornerstonePaymentsService
    {
        private readonly IHttpClientFactory _httpFactory;
        private readonly ILogger<ICornerstonePaymentsService> _logger;
        private readonly IConfiguration _configuration;
        public CornerstonePaymentsService(
            ILogger<ICornerstonePaymentsService> logger,
        ...
        #region cornerstone
        public async Task<BillPaymentsResponse> CornerstonePaymentAsync(CornerstoneRequest paymentRequest, CancellationToken cancellationToken)
        {

            _logger.LogInformation($"Inside CarpaddyPaymentAsync service request");
