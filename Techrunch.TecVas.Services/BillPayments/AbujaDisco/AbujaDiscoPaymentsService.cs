...
namespace Techrunch.TecVas.Services.BillPayments.AbujaDisco
{
    public class AbujaDiscoPaymentsService : IAbujaDiscoPaymentsService
    {
        ...
        #region AbujaDisco
        public async Task<BillPaymentsResponse> AbujaPrepaidAsync(AbujaPrepaidRequest paymentRequest, CancellationToken cancellationToken)
        {

            _logger.LogInformation($"Inside AbujaPrepaidAsync service request");
        ...
        public async Task<BillPaymentsResponse> AbujaPostpaidAsync(AbujaPostpaidRequest paymentRequest, CancellationToken cancellationToken)
        {

            _logger.LogInformation($"Inside AbujaPostpaidAsync service request");
