...
{
    public class MutualPaymentsService : IMutualPaymentsService
    {
        private readonly IHttpClientFactory _httpFactory;
        private readonly ILogger<IJambPaymentsService> _logger;
        private readonly IConfiguration _configuration;
        public MutualPaymentsService(
            ILogger<IJambPaymentsService> logger,
        ...
        #region MutualMVPaymentAsync
        public async Task<BillPaymentsResponse> MutualMVPaymentAsync(MutualMortorInsuranceRequest paymentRequest, CancellationToken cancellationToken)
        {

            _logger.LogInformation($"Inside JambPINPaymentAsync service request");
