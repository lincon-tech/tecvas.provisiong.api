...
{
    public class EkoElectricPaymentsService : IEkoElectricPaymentsService
    {
        private readonly IHttpClientFactory _httpFactory;
        private readonly ILogger<IEkoElectricPaymentsService> _logger;
        private readonly IConfiguration _configuration;
        public EkoElectricPaymentsService(
            ILogger<IEkoElectricPaymentsService> logger,
        ...
        #region EkoElectricDisco
        public async Task<BillPaymentsResponse> EkoElectricPrepaidAsync(EkoElectricPrepaidRequest paymentRequest, CancellationToken cancellationToken)
        {
        ...
        public async Task<BillPaymentsResponse> EkoElectricPostpaidAsync(EkoElectricPostpaidRequest paymentRequest, CancellationToken cancellationToken)
        {
