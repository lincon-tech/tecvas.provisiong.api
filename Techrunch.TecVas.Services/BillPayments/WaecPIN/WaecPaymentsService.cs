...
{
    public class WaecPaymentsService : IWaecPaymentsService
    {
        private readonly IHttpClientFactory _httpFactory;
        private readonly ILogger<IWaecPaymentsService> _logger;
        private readonly IConfiguration _configuration;
        public WaecPaymentsService(
            ILogger<IWaecPaymentsService> logger,
        ...
        #region WAECPIN
        public async Task<BillPaymentsResponse> WaecPINPaymentAsync(WaecPINRequest paymentRequest, CancellationToken cancellationToken)
        {
