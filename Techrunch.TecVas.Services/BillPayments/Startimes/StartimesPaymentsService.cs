...
{
    public class StartimesPaymentsService : IStartimesPaymentsService
    {
        private readonly IHttpClientFactory _httpFactory;
        private readonly ILogger<IStartimesPaymentsService> _logger;
        private readonly IConfiguration _configuration;
        public StartimesPaymentsService(
            ILogger<IStartimesPaymentsService> logger,
        ...
        #region Startimes
        public async Task<BillPaymentsResponse> StartimesPaymentAsync(StartimesRequest paymentRequest, CancellationToken cancellationToken)
        {
