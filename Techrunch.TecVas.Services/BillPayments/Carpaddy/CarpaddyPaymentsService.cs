...
{
    public class CarpaddyPaymentsService : ICarpaddyPaymentsService
    {
        private readonly IHttpClientFactory _httpFactory;
        private readonly ILogger<CarpaddyPaymentsService> _logger;
        private readonly IConfiguration _configuration;
        public CarpaddyPaymentsService(
            ILogger<CarpaddyPaymentsService> logger,
        ...
        #region carPaddy
        public async Task<BillPaymentsResponse> CarpaddyPaymentAsync(CarpaddyRequest paymentRequest, CancellationToken cancellationToken)
        {
