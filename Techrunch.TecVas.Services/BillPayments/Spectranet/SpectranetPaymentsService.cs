...
{
    public class SpectranetPaymentsService : ISpectranetPaymentsService
    {
        private readonly IHttpClientFactory _httpFactory;
        private readonly ILogger<ISpectranetPaymentsService> _logger;
        private readonly IConfiguration _configuration;
        public SpectranetPaymentsService(
            ILogger<ISpectranetPaymentsService> logger,
        ...
        #region Spectranet
        public async Task<BillPaymentsResponse> SpectranetRefillAsync(SpectranetRefillRequest paymentRequest, CancellationToken cancellationToken)
        {

            _logger.LogInformation($"Inside BulkSMSPaymentAsync service request");
        ...
        public async Task<BillPaymentsResponse> SpectranetPaymentPlanAsync(SpectranetPaymentPlanRequest paymentRequest, CancellationToken cancellationToken)
        {
        ...
        public async Task<BillPaymentsResponse> SpectranetPINAsync(SpectranetPINRequest paymentRequest, CancellationToken cancellationToken)
        {
