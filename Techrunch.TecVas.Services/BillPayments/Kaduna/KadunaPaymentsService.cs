...
using Techrunch.TecVas.Services.BillPayments.Kedco;
using Techrunch.TecVas.Entities.BillPayments.Kedco;
using Techrunch.TecVas.Services.BillPayments.Kaduna;
using Techrunch.TecVas.Entities.BillPayments.Kaduna;

namespace Techrunch.TecVas.Services.BillPayments.Kedco
{
    public class KadunaPaymentsService : IKadunaPaymentsService
    {
        private readonly IHttpClientFactory _httpFactory;
        private readonly ILogger<IKadunaPaymentsService> _logger;
        private readonly IConfiguration _configuration;
        public KadunaPaymentsService(
            ILogger<IKadunaPaymentsService> logger,
