...
{
    public class IkejaElectricPaymentsService : IIkejaElectricPaymentsService
    {
        private readonly IHttpClientFactory _httpFactory;
        private readonly ILogger<IIkejaElectricPaymentsService> _logger;
        private readonly IConfiguration _configuration;
        public IkejaElectricPaymentsService(
            ILogger<IIkejaElectricPaymentsService> logger,
