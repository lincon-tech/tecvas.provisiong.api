...
{
    public class SmilePaymentsService : ISmilePaymentsService
    {
        private readonly IHttpClientFactory _httpFactory;
        private readonly ILogger<ISmilePaymentsService> _logger;
        private readonly IConfiguration _configuration;
        public SmilePaymentsService(
            ILogger<ISmilePaymentsService> logger,
        ...
        #region Smile
        public async Task<BillPaymentsResponse> SmileBundlePaymentAsync(SmileCommBundleRequest paymentRequest, CancellationToken cancellationToken)
        {

            _logger.LogInformation($"Inside SmileBundlePaymentAsync service request");
        ...
        public async Task<BillPaymentsResponse> SmileRechargePaymentAsync(SmileCommRechargeRequest paymentRequest, CancellationToken cancellationToken)
        {

            _logger.LogInformation($"Inside SmileRechargePaymentAsync service request");
