...
using Techrunch.TecVas.Services.BillPayments.PortHarcourt;
using Techrunch.TecVas.Entities.BillPayments.PortharcourtElectric;

namespace Techrunch.TecVas.Services.BillPayments.Kedco
{
    public class PortHarcourtPaymentsService : IPortHarcourtPaymentsService
    {
        private readonly IHttpClientFactory _httpFactory;
        private readonly ILogger<PortHarcourtPaymentsService> _logger;
        private readonly IConfiguration _configuration;
        public PortHarcourtPaymentsService(
            ILogger<PortHarcourtPaymentsService> logger,
