...
{
    public class JosElectricPaymentsService : IJosElectricPaymentsService
    {
        private readonly IHttpClientFactory _httpFactory;
        private readonly ILogger<IJosElectricPaymentsService> _logger;
        private readonly IConfiguration _configuration;
        public JosElectricPaymentsService(
            ILogger<IJosElectricPaymentsService> logger,
