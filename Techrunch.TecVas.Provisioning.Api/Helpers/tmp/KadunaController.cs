...
using Chams.Vtumanager.Provisioning.Services.BillPayments.Kaduna;
...
namespace Chams.Vtumanager.Provisioning.Api.Controllers.v1
{
    ...
    public class KadunaController : Controller
    {
        private readonly ILogger<KadunaController> _logger;
        
        private readonly IKadunaPaymentsService _billspaymentService;
        private readonly ITransactionRecordService _transactionRecordService;


        
        public KadunaController(
            ILogger<KadunaController> logger,
            IKadunaPaymentsService billspaymentService
            )
        {
            _logger = logger;
            ...
            CancellationToken cancellation)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    var dstvresponse  = await _billspaymentService.KadunaPostpaidAsync(renewRequest, cancellation);
            ...
            CancellationToken cancellation)
        {
            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    var dstvresponse = await _billspaymentService.KadunaPrepaidAsync(renewRequest, cancellation);
